...
public class ChampionTest {
    ...
    @Before//test 실행되기 전 동작할 method 선
    public void setUp() {
    ...
    // 르블랑은 미드챔피언이라 조건으로 테스트 코드 작성
    @Test
    public void shouldLeblancIsMidChampion()
    {
        Optional<Champion> Leblanc = championList.stream()
                .filter(c->c.getName().equals("르블랑"))
                .findFirst();
        String ChampPosition = Leblanc.get().getPosition();
        assertTrue(ChampPosition.equals("미드"));
        assertThat("미드",is(ChampPosition));
    }
